...
use App\Http\Requests\UserManagement\UserAdminAddFormRequest;
use App\Http\Requests\UserManagement\UserAdminEditFormRequest;
...
class UserManagementController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            $query = $this->user->newQuery()
                ...
                ->where('transportir_id', $user->transportir_id);
    ...
    public function store(UserAdminAddFormRequest $request)
    {
        try {
            ...
            $user = auth()->user();
            $data['transportir_id'] = $user->transportir_id;
    ...
    public function edit($id)
    {
        try {
            ...
            return view('pages.admin.user-management.edit', compact('user', 'transportirs'));
        } catch (\Throwable $e) {
    ...
    public function update(UserAdminEditFormRequest $request, $id)
    {
        try {
            $data = $request->validated();
