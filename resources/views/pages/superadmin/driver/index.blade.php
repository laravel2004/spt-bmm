            ...
            <div class="card-header">
                <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-2">
                    ...
                    <div class="d-flex flex-column flex-md-row align-items-stretch align-items-md-center gap-2">
                        ...
                        <a href="{{ route('superadmin.driver.create') }}" class="btn btn-primary btn-sm">
                                    ...
                                    <td class="text-end">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a class="dropdown-item" href="{{ route('superadmin.driver.show', $d->id) }}">
                                                        <i class="bi bi-eye me-2"></i> Detail
                                                    </a>
                                                </li>
                                                <li><hr class="dropdown-divider"></li>
                                                <li>
                                                    <a class="dropdown-item" href="{{ route('superadmin.driver.edit', $d->id) }}">
                                                ...
                                                <li>
                                                    <button type="button" class="dropdown-item text-danger btn-delete-driver"
                                                            data-url="{{ route('superadmin.driver.delete', $d->id) }}"
